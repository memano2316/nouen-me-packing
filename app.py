...
MASTER_DATA = [
    ...
    {'genre': 'マイクロリーフ', 'name': 'マリーゴールド', 'g': '10', 'pack': 'SP'},
    ...
    {'genre': 'その他', 'name': 'レモンバーベナ', 'g': '10', 'pack': '横SP'},
    {'genre': 'その他', 'name': 'オレンジハーバルタイム', 'g': '8', 'pack': '横SP'},
    {'genre': 'その他', 'name': 'フレンチタイム', 'g': '10', 'pack': '横SP'},
    ...
    {'genre': 'エディブルフラワー', 'name': 'にんじん', 'g': '3', 'pack': 'SP'},
    ...
    {'genre': 'その他', 'name': 'いちじくの葉10枚入り', 'g': '10', 'pack': 'SP'},
]
